...
probes = [
  {
    name                = "https-443"        # Changed from http-443 to https-443
...
lb_rules = [
  {
    ...
    frontend_port           = 443
    backend_port            = 443
    probe_name              = "https-443"    # Updated to match new probe name
    ...
    load_distribution       = "None"         # Round-robin distribution (no session affinity)
  },
  {
    name                    = "http-80"
    protocol                = "Tcp"
